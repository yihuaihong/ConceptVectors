...
def execute_memit(
    ...
    if args.fact_erasure:
        print('running on fact_erasure...')
        for i, request in enumerate(requests):
            if request["target_new"]["str"][0] != " ":
                # Space required for correct tokenization
                requests[i]["target_new"]["str"] = " " + request["target_true"]["str"] #

    elif args.dummy_string:
        print('running on dummy_string...')
        for i, request in enumerate(requests):
            if request["target_new"]["str"][0] != " ":
                # Space required for correct tokenization
                requests[i]["target_new"]["str"] = " " + "dummy" #"I don't know" #dummy
    else:
        for i, request in enumerate(requests):
            if request["target_new"]["str"][0] != " ":
                # Space required for correct tokenization
